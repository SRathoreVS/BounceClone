class Game {
  constructor(containerId, options) {
    ...
    this.bg = new Image();
    this.bg.src = "assetts/bg/level-select.png";
    this.startCanvas;
    this.start();
  }
  ...
  start() {
    ...
    playBtn.src = "assetts/tile/menu_button_play.png";
    const logo = new Image();
    logo.src = "assetts/tile/menu_logo.png";
    const ball = new Image();
    ball.src = "assetts/tile/ball_small.png";
  ...
  levelSelect() {
    ...
    levelUnlocked.src = "assetts/tile/lselect_level.png";
    const levelLocked = new Image();
    levelLocked.src = "assetts/tile/lselect_level_locked.png";
    const lockIcon = new Image();
    lockIcon.src = "assetts/tile/lselect_keylock.png";
    const yellowStarIcon = new Image();
    yellowStarIcon.src = "assetts/tile/lselect_star.png";
    const greyStarIcon = new Image();
    greyStarIcon.src = "assetts/tile/lselect_star_grey.png";
    ...
    crown.src = "assetts/tile/crown.png";
    const failed = new Image();
    failed.src = "assetts/tile/failed_title.png";
    const yellowstar = new Image();
    yellowstar.src = "assetts/tile/star_yellow.png";
    const greystar = new Image();
    greystar.src = "assetts/tile/star_gray.png";
    const nextBtn = new Image();
    nextBtn.src = "assetts/tile/button_next.png";
    const retryBtnSmall = new Image();
    retryBtnSmall.src = "assetts/tile/small_button_retry.png";
    const retryBtnLarge = new Image();
    retryBtnLarge.src = "assetts/tile/button_retry.png";
    const menuBtn = new Image();
    menuBtn.src = "assetts/tile/button_menu.png";
